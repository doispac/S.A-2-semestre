...
CREATE TABLE `tb_fornecedor` (
  `id_fornecedor` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT,
  `nm_fornecedor` varchar(40) NOT NULL,
  ...
  UNIQUE KEY `nm_fornecedor` (`nm_fornecedor`),
...
INSERT INTO `tb_fornecedor` VALUES (0000000001,'SEP REPRESENTACOES COMERCIAIS LTDA ME','17.600.100/0001-51','RUA PEDRO STOKLOSA 81','99912-2332','sher.mafra@gmail.com');
